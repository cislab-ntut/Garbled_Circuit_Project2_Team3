...
class GarbledGate:
    ...
    def __init__(self, gate, keys, pbits):
        ...
        switch = {
            ...
            "ans1":lambda A, B: A and (not B),
            "ans2": lambda D, E: D and E,
            "ans3": lambda E, F: ((not E)and(not F)),
            "MOD2" : lambda A,B,C,D,E,F: ((not E)and(not F)) or (A and (not B)and D and E),
            "MOD1": lambda A, B, C, D, E, F: ((not E)and(not F)) or (B and(not F)) or ((not C)and(not D)and E) or ((not A)and B and E) or ((not A)and(not B)and(not C)and D) or (A and (not B) and (not C)and E) or (A and (not B) and (not D) and E and F),
        }
